...
import { Eye, EyeOff, Building2, Phone, Mail, Lock, Upload } from "lucide-react";
      ...
      >
        <defs>
          <pattern id="dots" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
            <polygon points="12,5 21,12 12,19 3,12" fill="#ffffffc9" fillOpacity="1" />
          </pattern>
        </defs>
        ...
        >
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={inputStyle}
                />
                <span style={iconRight}><Building2 size={15} /></span>
              </div>
            </div>
            {/* رقم الهاتف */}
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                <span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "#9ca3af", display: "flex" }}>
                  <Phone size={15} />
                </span>
              </div>
            </div>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              />
              <span style={iconRight}><Mail size={15} /></span>
            </div>
          </div>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              />
              <span style={iconRight}><Lock size={15} /></span>
              <button
