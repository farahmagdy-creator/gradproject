      ...
      <div className="row align-items-center">
        <div className="col-md-7">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <span className="badge rounded-pill px-3" style={{color: "#940fc9", border: "1px solid #940fc9"}}>في الانتظار</span>
            <button className="btn btn-sm rounded-pill px-3 fw-bold" style={{color: "#ba1a1a", border: "1px solid #ba1a1a"}}><AlertTriangle size={12} /> وضع علامة عاجل</button>
          </div>
        </div>
        <div className="col-md-5 d-flex gap-2 justify-content-end">
          <button className="btn border btn-sm px-3 py-2" style={{background: "#e9e8e9" }}><Printer size={16} /> طباعة الإيصال</button>
          <button className="btn border btn-sm px-3 py-2" style={{background: "#e9e8e9" }}><UserPlus size={16} />  تعيين فني</button>
          <button className="btn btn-light border btn-sm px-3 py-2" style={{ border: "#c3c6d5"}}><Edit3 size={16} /> تعديل الإيصال</button>
        </div>
      </div>
