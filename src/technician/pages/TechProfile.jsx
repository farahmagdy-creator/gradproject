      ...
      >
        ...
        <div className="d-flex align-items-center gap-4" style={{ direction: "ltr" }}>
          ...
          <div className="d-flex align-items-center gap-3" style={{ marginTop: "75px" }}>
            <div
              className="bg-white rounded-3 px-4 py-2 fw-semibold text-secondary d-flex align-items-center gap-2"
      ...
      <div className="row g-4">
        ...
        <div className="col-6">
          <div className="d-flex gap-3">
            ...
            {/* صورة البطاقة */}
            <div style={{ flexShrink: 0, marginTop: "35px", marginRight:"55px"}}>
              <img
                src="image/id.jpg"
                alt="بطاقة الهوية"
        ...
        <div className="col-12 mt-2">
          ...
          <div className="d-flex align-items-center gap-2 mb-3 mt-3">
           ...
           <p style={{color: "#003174"}}>الصلاحيات الممنوحة</p>
